    ...
    <div class="container">
        ...
        <form action="<%=request.getContextPath()%>/student-register" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact-no" name="contact-no" required placeholder="Enter your contact number">
            </div>

            <button type="submit">Register</button>

            <p class="error-msg">
                <%if (session.getAttribute("email-already-used") != null) { %>
            ...
            <p class="success-msg">
                <%if (session.getAttribute("registration-success") != null) { %>
            ...
            <div class="login-link">
                Already have an account? <a href="<%=request.getContextPath()%>/pages/student/student-login.jsp">Login here</a>
            </div>
        </form>
    </div>
</body>
